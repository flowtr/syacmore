...
/// [`View`]s. Using this will minimize re-renders instead of re-rendering every
/// view node on every state change.
///
...
/// rendering an array of [`View`]s. Using this will minimize re-renders instead
/// of re-rendering every single node on every state change.
///
