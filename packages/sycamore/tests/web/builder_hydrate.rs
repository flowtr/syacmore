...
//         check(
//             &sycamore::render_to_string(v),
//             expect![[r#"<div data-hk="0.0"><p
// data-hk="0.1">Nested</p></div>"#]],         );
//     }
//     #[wasm_bindgen_test]
//     fn test() {
//         let html = sycamore::render_to_string(v);
...
//         check(
//             &sycamore::render_to_string(v),
//             expect![[r#"<p data-hk="0.0">First</p><p
// data-hk="0.1">Second</p>"#]],         );
//     }
//     #[wasm_bindgen_test]
//     fn test() {
//         let html = sycamore::render_to_string(v);
...
// mod dynamic {
//     use super::*;
//     fn v<'a, G: Html>(ctx: ScopeRef<'a>, state: &'a ReadSignal<i32>) ->
// View<G> {         view! { ctx, p { (state.get()) } }
//     }
//     #[test]
//     fn ssr() {
//         check(
...
//     #[wasm_bindgen_test]
//     fn test() {
//         let html = sycamore::render_to_string(|ctx| v(ctx,
// ctx.create_signal(0)));         let c = test_container();
//         c.set_inner_html(&html);
...
//     use super::*;
//     fn v<'a, G: Html>(ctx: ScopeRef<'a>, state: &'a ReadSignal<i32>) ->
// View<G> {         view! { ctx, p { "Value: " (state.get()) "!" } }
//     }
//     #[test]
//     fn ssr() {
//         check(
...
//     use super::*;
//     fn v<'a, G: Html>(ctx: ScopeRef<'a>, state: &'a ReadSignal<View<G>>) ->
// View<G> {         view! { ctx, p { "before" (*state.get()) "after" } }
//     }
//     #[test]
//     fn ssr() {
//         check(
//             &sycamore::render_to_string(|ctx| v(ctx, ctx.create_signal(view!
// { ctx, "text" }))),             expect![[r##"<p
// data-hk="0.0">before<!--#-->text<!--/-->after</p>"##]],         );
//     }
//     #[wasm_bindgen_test]
//     fn test() {
//         let html =
//             sycamore::render_to_string(|ctx| v(ctx, ctx.create_signal(view! {
// ctx, "text" })));         let c = test_container();
//         c.set_inner_html(&html);
